...
type FC<T> = React.FC<T> & { a?: number };
export const StretchResize2: FC<ResizeProps> = () => 123;
/**
 * 调整元素的宽高
 */
...
function C(props: { a: 123 }) {
    return <div>123</div>
}
type GetRef={getR:()=>void}
export const A = React.forwardRef((props: { a: 123 }, ref: React.ForwardedRef<GetRef>) => {
    return 123
})
